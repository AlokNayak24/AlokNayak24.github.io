/**
 * siteData — single source of truth for all portfolio content.
 * Ported 1:1 from the previous static site's javascript/data.js.
 * Fields marked `placeholder: true` are visible but not yet real —
 * do not invent real URLs/values for them.
 */
...
export type AiToolStatus = "Production" | "Freelancing" | "Personal";
...
export const siteData: SiteData = {
  ...
  about: {
    ...
    principles: [
      ...
      { title: "🧠 AI-First Engineer", desc: "8+ years turning manual QA into intelligent, AI-assisted automation — from custom test-generation agents to production monitoring systems." },
    ],
  },
  ...
  skills: {
    core: [
      ...
      { category: "AI Testing", items: ["ChatGPT", "Codex", "Claude Code", "Claude AI", "Lovable", "GitHub Copilot", "AI Agent Development", "Prompt Engineering"] },
      { category: "CI/CD & Tools", items: ["Jenkins", "Maven", "Git", "JIRA", "Zephyr Scale", "Allure Reports", "JMeter", "Eclipse", "IntelliJ IDE"] },
      { category: "Methodology", items: ["Hybrid Framework (Data-Driven, BDD)", "Page Object Model", "Agile/Scrum", "SDLC/STLC", "Cucumber/BDD"] },
    ],
    exploring: ["Cypress", "Appium", "Docker", "AWS", "Azure DevOps", "Gradle", "BrowserStack"],
  },
  ...
  education: [
    ...
    { degree: "Higher Secondary (Science)", school: "CHSE, Odisha", year: "2013" },
  ],
  ...
  certifications: [
    ...
    { name: "Claude 101", issuer: "Anthropic", year: "2026", verifyUrl: "https://verify.skilljar.com/c/jn4dqcsfb2sy", placeholder: true, image: "img/certificates/Claude 101.png" },
  ...
  projects: [
    {
      ...
      githubUrl: "https://github.com/AlokNayak24",
      demoUrl: "#",
      caseStudyUrl: "case-study.html?id=nexsure-insurance",
      caseStudy: {
        overview:
    ...
    },
    {
      ...
      githubUrl: "https://github.com/AlokNayak24",
      demoUrl: "#",
      caseStudyUrl: "case-study.html?id=ai-copilot-scripting",
      caseStudy: {
        overview:
    ...
    },
    {
      ...
      githubUrl: "https://github.com/AlokNayak24",
      demoUrl: "#",
      caseStudyUrl: "case-study.html?id=api-integration-suite",
      caseStudy: {
        overview:
    ...
    },
    {
      ...
      githubUrl: "https://github.com/AlokNayak24",
      demoUrl: "#",
      caseStudyUrl: "case-study.html?id=hybrid-bdd-framework",
      caseStudy: {
        overview:
    ...
    },
    {
      ...
      githubUrl: "https://github.com/AlokNayak24",
      demoUrl: "#",
      caseStudyUrl: "case-study.html?id=playwright-practice",
      caseStudy: {
        overview:
  ...
  aiTools: [
    {
      ...
      caseStudy: {
        ...
        features: [
          { icon: "🤖", title: "AI Test Case Generation", points: ["Generates comprehensive test cases directly from Jira user stories.", "Creates positive, negative, boundary, and edge-case scenarios.", "Automatically generates test steps, expected results, and test data."] },
          { icon: "🎯", title: "Requirement Coverage", points: ["Maps generated test cases with Jira requirements.", "Identifies uncovered business scenarios.", "Ensures high requirement traceability and coverage."] },
          { icon: "🎭", title: "Playwright Automation", points: ["Automatically generates Playwright automation scripts.", "Supports reusable page objects and modular framework.", "Accelerates UI automation development."] },
          { icon: "🛠️", title: "Self-Healing Automation", points: ["Detects broken UI locators automatically.", "Repairs locator strategies using AI.", "Reduces maintenance effort for automation suites."] },
          { icon: "⚡", title: "Smart Test Execution", points: ["Executes automated test suites on demand.", "Runs parallel execution for faster feedback.", "Supports scheduled regression execution."] },
          { icon: "🔍", title: "AI Root Cause Analysis", points: ["Analyzes failed test executions automatically.", "Classifies failures as application defects, locator issues, or environment problems.", "Provides AI-generated troubleshooting suggestions."] },
          { icon: "📤", title: "Zephyr Integration", points: ["Automatically uploads generated test cases to Zephyr.", "Updates execution results after test completion.", "Maintains requirement traceability with Jira."] },
          { icon: "📋", title: "Jira Integration", points: ["Imports Jira stories and requirements automatically.", "Creates bugs directly from failed executions.", "Synchronizes testing progress with development teams."] },
          { icon: "📊", title: "Executive Dashboard", points: ["Displays AI usage and token consumption.", "Tracks execution statistics and automation coverage.", "Provides real-time QA insights and project metrics."] },
          { icon: "🔐", title: "Secure User Management", points: ["JWT authentication with role-based access control.", "Supports Admin, Manual QA, Automation QA, and Viewer roles.", "Multi-organization architecture with secure data isolation."] },
          { icon: "🐳", title: "Cloud-Native Architecture", points: ["Containerized using Docker and Docker Compose.", "Built with FastAPI, React, PostgreSQL, and Redis.", "Designed for scalable enterprise deployments."] },
        ],
        impact: [
        ...
        techUsed: ["React", "TypeScript", "Vite", "Tailwind CSS", "FastAPI", "Python", "SQLAlchemy", "Alembic", "PostgreSQL", "Redis", "Docker", "JWT Authentication", "Playwright", "Jira API", "Zephyr API", "OpenAI", "Claude", "REST APIs", "GitHub"],
        result:
    ...
    },
    {
      ...
      caseStudy: {
        ...
        features: [
          { icon: "🖥️", title: "Server Uptime Monitoring", points: ["Continuously monitors production servers (24×7).", "Detects server downtime and service interruptions.", "Tracks overall system availability."] },
          { icon: "🌐", title: "API Health Monitoring", points: ["Validates critical REST API endpoints.", "Detects HTTP 4xx/5xx errors.", "Monitors API response status and availability."] },
          { icon: "⏱️", title: "Response Time Tracking", points: ["Measures API latency in real time.", "Identifies slow-performing services.", "Detects timeout scenarios before they impact users."] },
          { icon: "🔔", title: "Instant Notifications", points: ["Sends real-time alerts on failures.", "Notifies QA and Engineering teams immediately.", "Helps reduce Mean Time to Detect (MTTD)."] },
          { icon: "📊", title: "Production Health Dashboard", points: ["Displays live service status.", "Tracks uptime trends and system health.", "Provides quick visibility into production stability."] },
          { icon: "🛠️", title: "Deployment Validation", points: ["Automatically verifies application health after every production deployment.", "Confirms critical business services are functioning as expected."] },
          { icon: "🤝", title: "Cross-Team Collaboration", points: ["Worked closely with Developers, DevOps, and Product teams.", "Assisted in rapid issue identification and root cause analysis."] },
        ],
        impact: [
    ...
    },
    {
      ...
      caseStudy: {
        ...
        features: [
          { icon: "🤖", title: "AI Test Case Generation", points: ["Generates detailed test cases from user stories and requirements.", "Creates positive, negative, boundary, exploratory, and regression scenarios.", "Automatically generates preconditions, test data, steps, and expected results."] },
          { icon: "🎯", title: "Requirement Coverage Analysis", points: ["Maps test cases to business requirements.", "Identifies uncovered scenarios automatically.", "Ensures near-complete functional coverage with traceability."] },
          { icon: "🧪", title: "Edge Case Intelligence", points: ["Automatically generates boundary value and negative test scenarios.", "Identifies hidden edge cases using AI reasoning.", "Improves defect detection before production deployment."] },
          { icon: "📚", title: "RAG Knowledge Engine", points: ["Retrieves project documentation, APIs, and business rules.", "Generates context-aware test cases using enterprise knowledge.", "Reduces hallucinations by grounding AI responses with project data."] },
          { icon: "🔌", title: "MCP Integration", points: ["Connects AI agents with enterprise tools using Model Context Protocol.", "Accesses Jira, Confluence, APIs, and documentation securely.", "Provides seamless AI workflow orchestration."] },
          { icon: "👥", title: "Multi-Agent AI Workflow", points: ["Requirement Analysis Agent interprets business requirements.", "Test Design Agent generates intelligent test scenarios.", "Coverage Agent validates requirement mapping.", "Review Agent verifies quality and removes duplicate test cases.", "Publishing Agent uploads approved test cases automatically."] },
          { icon: "✅", title: "AI Review & Verification", points: ["Automatically reviews generated test cases.", "Validates formatting, consistency, and completeness.", "Detects duplicate or low-quality scenarios before publishing."] },
          { icon: "📤", title: "Automatic Zephyr Integration", points: ["Publishes approved test cases directly to Zephyr.", "Creates folders, suites, and requirement mappings.", "Eliminates manual test management effort."] },
          { icon: "📊", title: "AI Analytics Dashboard", points: ["Tracks AI token consumption and usage statistics.", "Monitors generation success rate and execution metrics.", "Provides cost analysis and performance insights."] },
          { icon: "⚡", title: "Prompt Engineering", points: ["Uses optimized prompt templates for consistent output.", "Supports reusable prompt libraries.", "Improves AI accuracy through prompt optimization."] },
        ],
        impact: [
          "Reduced manual test case creation effort by up to 80%.",
        ...
        techUsed: ["LLMs", "OpenAI", "Claude", "RAG", "MCP", "Multi-Agent AI", "Prompt Engineering", "Python", "Java", "REST APIs", "Zephyr API", "Jira", "Confluence", "SQL", "Vector Database", "JSON", "Dashboard Analytics", "RBAC"],
        result:
    ...
    },
    {
      ...
      caseStudy: {
        ...
        features: [
          { icon: "📊", title: "Executive Dashboard", points: ["15 config-driven KPI cards — QA Health Score, Release Readiness, Sprint Progress, Automation Coverage, AI Risk Score, and more — many clickable into filtered ticket drill-downs.", "AI-generated executive briefing with headline, summary, highlights, risks, and a recommendation.", 'Product Team, Implementation, and Automation share one parameterized team dashboard view, since Jira itself has no native "team" concept.'] },
          { icon: "🗂️", title: "Daily Board", points: ['Rebuilds every gadget of the real Jira "QA-Overall_Status" dashboard from synced Postgres data — never a live Jira JQL call — so it renders identically regardless of the viewer\'s Jira permissions.', "Every chart, legend slice, and table column is independently filterable, with client-side pagination and a CSV export that respects every active filter.", "Pod Details breaks out one pie chart per real Squad value present in the data, with an explicit custom sort order instead of a hardcoded pod list."] },
          { icon: "🐞", title: "Bug Intelligence", points: ["Open/closed/reopened counts, priority and status breakdowns, and an aging bucket for open bugs.", "Escaped/production-defect counts, duplicate and recurring-bug detection, and root-cause breakdown.", "Per-sprint opened-vs-closed trend plus a next-period forecast."] },
          { icon: "🏃", title: "Sprint Intelligence", points: ["Live sprint health: completion %, velocity across the last 4 closed sprints plus the current one, and a burndown derived from ticket resolution timestamps.", "Blocked-story count, testing progress %, carry-over prediction, and an overall health score.", "Target sprint resolves to the explicit filter, else the project's active sprint, else its most recently started sprint."] },
          { icon: "🏆", title: "QA Analytics Leaderboard", points: ["Ranks QA engineers by Jira QA Label across total/testing/completed/pending/blocked/hotfix/regression ticket counts and bugs logged.", "Quality Score starts at 100 and is penalized only for reopened tickets, weighted 1.5×.", "AI Performance Score blends quality (50%), productivity (30%), and blocked ratio (20%) into one transparent, formula-driven score."] },
          { icon: "✅", title: "Test Cases (Zephyr Scale)", points: ["Test case and cycle coverage per team, with pass/fail/blocked/not-executed breakdowns.", "Paginated drill-down execution lists, synced independently of the Jira ticket pipeline."] },
          { icon: "🔎", title: "Jira Filters", points: ["The one place in the app that calls Jira JQL live by design — browses the account's own saved Filters and Dashboards.", "Pie-chart breakdowns plus a filterable, paginated Jira-style issue table."] },
          { icon: "📅", title: "Release Calendar", points: ["A deterministic 2026 release calendar generated client-side from the org's documented cadence — weekly sprints, monthly service packs, Windows patching windows, and quarterly releases."] },
          { icon: "🔐", title: "Auth & Roles", points: ["Email/password login with optional email-based 2FA (5-minute TTL) and rotating JWT refresh tokens stored hashed, not reused.", "Five roles — Admin, QA Manager, QA Lead, QA Engineer, Viewer — enforced end-to-end via a RolesGuard, from user management down to read-only access."] },
          { icon: "🔌", title: "Jira & Zephyr Sync Engine", points: ["Provider-agnostic sync: mock and real Jira providers implement the same interface, so every downstream page is provider-agnostic.", "Six custom fields — QA Label, Deployment Type, Squad, Release Target, Sprint, Environment — resolve by human-readable name to their real Jira custom field IDs.", "A parallel Zephyr Scale integration handles per-ticket test-case-count backfill plus a fuller test case/cycle/execution sync, scoped per team."] },
        ],
        impact: [
        ...
        techUsed: ["Next.js 14", "React 18", "TypeScript", "Tailwind CSS", "Recharts", "Zustand", "TanStack Query", "Radix UI", "Framer Motion", "NestJS 10", "Prisma 5", "PostgreSQL 16", "Redis 7", "BullMQ", "JWT Authentication", "Anthropic Claude SDK", "Turborepo", "Docker"],
        result:
  ...
  blogs: [
    { title: "Building an AI Agent That Writes Your Test Cases", excerpt: "How I wired ChatGPT and Claude AI into a pipeline that reads user stories and pushes ready-to-run test cases into Zephyr Scale.", tags: ["AI", "Test Automation", "LLM"], readingTime: "7 min", url: "#", placeholder: true },
    { title: "80% Automation Coverage: Lessons from an Insurance Platform", excerpt: "What it actually takes to automate regression on a regulated U.S. insurance platform without breaking compliance.", tags: ["Selenium", "AccelQ", "Insurance"], readingTime: "6 min", url: "#", placeholder: true },
    { title: "Prompt Engineering for QA: Testing LLM Applications", excerpt: "A practical framework for validating conversational AI — prompt-response accuracy, context retention, and edge-case prompts.", tags: ["Prompt Engineering", "LLM Testing"], readingTime: "8 min", url: "#", placeholder: true },
  ],
...
export const STATUS_META: Record<AiToolStatus, { className: string; label: string }> = {
  Production: { className: "status-production", label: "Production — Live" },
  Freelancing: { className: "status-freelancing", label: "Freelance — Project" },
  Personal: { className: "status-personal", label: "Personal — Project" },
};
